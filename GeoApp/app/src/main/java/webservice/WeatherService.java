...
public class WeatherService extends IntentService {
    ...
    private static final String BASE_URL = "https://api.darksky.net/forecast/882e7468c682e1f91d7b57c1f6baf4f5/";
    ...
    private void fetchWeatherData(String key, String lat, String lon, String time) {
        try {
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                ...
                result.putExtra("ICON", current.getString("icon"));
                result.putExtra("SUMMARY", current.getString("summary"));
                result.putExtra("TEMPERATURE", current.getDouble("temperature"));
